...
mobs:register_mob("mobs:survivor", {
	type = "monster",
	hp_max = 10,
	visual = "mesh",
	mesh = "survivor.x",
	...
	drops = {
		...
		min = 3,
		max = 5,},
		{name = "docfarming:cornseed",
		chance = 100,
		min = 1,
		max = 2,},
		{name = "docfarming:raspberryseed",
		chance = 20,
		min = 1,
		max = 2,},
		{name = "docfarming:carrotseed",
		chance = 20,
		min = 1,
		max = 2,},
		{name = "docfarming:potatoseed",
		chance = 20,
		min = 1,
		max = 2,},
		{name = "docfarming:cucumberseed",
		chance = 20,
		min = 1,
		max = 2,},
	},
	...
	animation = {
		speed_normal = { x=168, y=187, },
		speed_run = { x=168, y=187, },
		stand_start = { x=  0, y= 79, },
		stand_end = { x=  0, y= 79, },
		walk_start = { x=168, y=187, },
		walk_end = { x=168, y=187, },
		run_start = { x=168, y=187, },
		run_end = { x=168, y=187, },
		punch_start = { x=200, y=219, },
		punch_end = { x=200, y=219, },
	}
})
mobs:register_spawn("mobs:survivor", {"default:dirt_with_grass"}, 20, -1, 7000, 1, 31000)
